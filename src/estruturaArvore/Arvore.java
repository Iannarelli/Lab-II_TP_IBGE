...
public class Arvore {
	...
	private NodoPessoa raiz; // referência à raiz da árvore.
        ...
        else
        {
            ...
            else
            {
                ...
                if (raizArvore.item.getIdentidade() < pessoaNova.getIdentidade())
                    ...
                    System.out.println("A pessoa " + pessoaNova.getNome() + ", cuja identidade é " + pessoaNova.getIdentidade() + ", já foi inserida anteriormente na árvore.");
            }
        }
        /// Retorna a raiz atualizada da árvore ou sub-árvore em que o aluno foi adicionado.
        return raizArvore;
    ...
    private NodoPessoa retirar(NodoPessoa raizArvore, float identidade)
    {
        ...
        if (raizArvore == null)
        {
        	 System.out.println("A pessoa, cuja identidade é " + identidade + ", não foi encontrada.");
            return raizArvore;
        }
        else
        {
