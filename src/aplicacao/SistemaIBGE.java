	...
	public static void main(String[] args) {
		...
		do {
					...
					if (manipulador.getArvore().pesquisar(Long.parseLong(dados[0])) == null) {
						...
						do {
							...
							if (!dados[5].equalsIgnoreCase("solteiro") && !dados[5].equalsIgnoreCase("solteira")
									...
									&& !dados[5].equalsIgnoreCase("viuva") && !dados[5].equalsIgnoreCase("vi�vo")
									&& !dados[5].equalsIgnoreCase("vi�va"))
								System.out.print(
								...
								&& !dados[5].equalsIgnoreCase("vi�vo") && !dados[5].equalsIgnoreCase("vi�va"));/*************AQUI***************/
						...
						System.out.println("A identidade " + identidade + " j� est� dadastrada."); /*************AQUI***************/
						mostraMenu = true;
					}
				}
				break;
						...
						case 5:
							...
							do {
								...
								if (!dados[5].equalsIgnoreCase("solteiro") && !dados[5].equalsIgnoreCase("solteira")
										...
										&& !dados[5].equalsIgnoreCase("vi�vo") && !dados[5].equalsIgnoreCase("vi�va"))
									System.out.print(
											"\tInforma��o inv�lida. Informe novamente o estado civil (solteiro / casado / divorciado /"
													+ " vi�vo): ");
							} while (!dados[5].equalsIgnoreCase("solteiro") && !dados[5].equalsIgnoreCase("solteira")
			...
			case 7:
				...
				System.out.printf("Vi�vo(a): %.0f (%.2f%%)\n", viuvo, viuvo/populacaoTotal*100);
				System.out.printf("____________________________________________________________________________________________________\n");
				...
				System.out.println("\n********** RELAT�RIO ESTATISTICO **********");
				System.out.printf("M�dia de idade geral: %.1f anos\n", (totalIdadeF+totalIdadeM)/populacaoTotal);
				System.out.printf("____________________________________________________________________________________________________\n");
